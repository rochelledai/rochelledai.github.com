(function(){
    ...
    function homeclick(e) {
        ...
        let imgid = e.target; 
        let toppos = 200; //the end position that we want the img to be in
        let leftpos = 110;
        ...
        switch (imgid.id) {
            ...
            case "cd":
                ...
                desbody.innerHTML="<i>Click object to play audio</i><br><br> This was one of my mother's favorite songs when she was in her twenties.";
            ...
            case "english":
                ...
                desbody.innerHTML="<i>Click object to play audio</i><br><br> After studying as a nurse in China, my mother immigrated to the US. She learned English through cassettes like these. Even today, she makes sure to take note of words she doesn't recognize, so that she can later ask me about them.";
            ...
            case "eyes":
                ...
                desbody.innerHTML="<i>Click object to play audio</i><br><br> After spending 4 years in Michigan, my mother moved to California, where her first job was a Chinese language instructor. She specifically asked her father in China to mail over these cassettes so that she can use them in class.";
    ...
    function playpause(mainobj, song){
        if (isPlaying(song)==false){
            ...
            //CLICK ONLY WORKS IF THE FUNCTION IS ANONYMOUS. BUT ALSO ERROR BC MULTIPLE CLICK EVENTS. HOW TO FIX???
